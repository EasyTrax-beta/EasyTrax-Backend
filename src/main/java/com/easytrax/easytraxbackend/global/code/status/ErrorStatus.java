package com.easytrax.easytraxbackend.global.code.status;
...
public enum ErrorStatus implements BaseErrorCode {
    ...
    PROJECT_TARGET_COUNTRY_NOT_FOUND(HttpStatus.BAD_REQUEST, "PROJECT4047", "프로젝트의 목적지 국가 정보가 설정되지 않았습니다."),
